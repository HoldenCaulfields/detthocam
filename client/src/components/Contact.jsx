...
const Contact = () => {
    return (
        <section id="contact" className="w-full flex flex-col items-center justify-center text-center px-6 py-10 background-gradient bg-gradient-to-r from-red-50 to-gray-100">
